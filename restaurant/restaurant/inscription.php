                                ...
                                <section class="contactez_moi">
                                    <div class="formulaire">
                                        ...
                                        <div class="formulaire_cont">
                                            ...
                                            <input class="form-control" id="mdp" name="mdp" type="password" placeholder="Entrer votre mot de passe"  required>
                                        </div>
                                        <div class="formulaire_cont">
                                            <label><b>Valider mot de passe</b></label>
                                            <input class="form-control" id="mdp-2" name="mdp_2" type="password" placeholder="Veuillez valider votre mot de passe"  required>
                                        </div>
                                            <div class="form-group">
                                                <button class="btn" type="submit">S'inscrire</button>
                                        </div>
                                        <!-- Redirection vers la page connexion-->
                                        <p>Vous avez déjà un compte ? <a class="lien_compte" href="co-a_supp.html">Cliquez ici</a></p>
